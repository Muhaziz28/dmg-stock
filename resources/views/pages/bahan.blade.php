...
@section('title', 'Data Bahan Barang')
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2">Data Bahan Barang</h4>
        ...
        <div class="mb-4">
            <div class="alert alert-info d-flex" role="alert">
                ...
                <div class="d-flex flex-column ps-1">
                    ...
                    <span>Data bahan terhubung dengan data barang, setiap nama bahan diubah, akan mengubah bahan yang tersimpan pada data barang!</span>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-datatable table-responsive">
                <table class="datatables-bahan table border-top" id="bahan-table">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama</th>
        ...
        <!-- Modal -->
        <div class="modal fade" id="bahanModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-simple">
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form class="needs-validation" action="{{ route('dmg.addBahan') }}" method="POST" id="add-bahan-form">
                            @csrf
    ...
    $(function() {
        ...
        $('#add-bahan-form').submit(function(e) {
            ...
            $.ajax({
                ...
                contentType: false,
                beforeSend: function() {
                    $('#add-bahan-form button[type="submit"]').html('<i class="fa fa-spinner fa-spin"></i>');
                },
                success: function(data) {
                    if (data.code == 0) {
                        ...
                        $('#bahan-table').DataTable().ajax.reload(null, false);
        ...
        // ! GET VARIASI
        var table = $('.datatables-bahan')

        if (table.length) {
            dt_divisi = table.DataTable({
                ajax: '{{ route("dmg.getBahan") }}',
                listView: {
                    layout: true,
                    columnFilters: false,
                    checkbox: false,
